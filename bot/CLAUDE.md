...
- **Procesamiento de Lenguaje Natural (NLU):**
  ...
  - Prompts estructurados en [system_prompt.py](file:///home/angelmanuelsanchezhipolito/Projects/IA-Tr%C3%A1mites-Gubernamentales/tramites-gubernamentales/bot/app/prompts/system_prompt.py) para clasificación (`SYSTEM_PROMPT_CLASSIFIER`) y extracción sin falsos inferidos de modalidad (`SYSTEM_PROMPT_EXTRACTOR`).
